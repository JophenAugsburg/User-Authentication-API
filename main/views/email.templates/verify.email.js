 ...
 * 
 * This is an HTML layout for email verification emails
...
link : the URL link they must go to to verify their eamil
 */
module.exports.verifyEmail = (companyName, firstName, link) => `
<!doctype html>
<html>
  <head>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Please complete your account by confirming your email address.</p>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">If the link above does not work, copy and paste this URL in your browser</p>
                        <a href="${link}" style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${link}</a>
                      </td>
                    </tr>
                  </table>
                </td>
